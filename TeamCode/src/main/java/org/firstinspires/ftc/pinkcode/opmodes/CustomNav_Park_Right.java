...
public class CustomNav_Park_Right extends LinearOpMode {
    ...
    /*
        Park in warehouse from right start position
     */
    ...
    public void runOpMode() throws InterruptedException {
        ...
        this.Navigation.driveToPos(32, Base.imu.getAngularOrientation().thirdAngle, Base.getBasePosCounts(), Base.imu.getAngularOrientation().thirdAngle, 5, Constants.DRIVE_SPEED);
