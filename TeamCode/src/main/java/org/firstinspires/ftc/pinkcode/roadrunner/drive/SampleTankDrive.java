package org.firstinspires.ftc.pinkcode.roadrunner.drive;
...
import static org.firstinspires.ftc.pinkcode.roadrunner.drive.DriveConstants.MAX_VEL;
import static org.firstinspires.ftc.pinkcode.roadrunner.drive.DriveConstants.MOTOR_VELO_PID;
import static org.firstinspires.ftc.pinkcode.roadrunner.drive.DriveConstants.RUN_USING_ENCODER;
...
public class SampleTankDrive extends TankDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(0.6, 0.02, 0.02);
...
//         BNO055IMUUtil.remapZAxis(imu, AxisDirection.NEG_);

        // add/remove motors depending on your robot (e.g., 6WD)
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "leftF");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "leftB");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "rightB");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "rightF");
